...
/**
 * Search for results that partially match the specified fields. THIS FUNCTION IS NOT PERMENANT
...
*/
exports.makeListing = function makeListing_(username_, isbn13_, forRent, forSale, forBorrow, price_, function_) {
    list_i.makeListing(username_, isbn13_, forRent, forSale, forBorrow, price_, function_);
}
