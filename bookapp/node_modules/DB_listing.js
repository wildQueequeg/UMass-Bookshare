...
exports.makeListing = function makeListing_(username_, isbn13_, forRent_, forSale_, forBorrow_, price_, function_)
{
		...
		if(record != null)
		{
			...
			for(var i = 0; i < record.length; i++){
				listValues[i] = {
					...
					price : record[i].dataValues.price,
...
exports.findBookListing = function findBookListing_(isbn13_, function_)
{
	...
	// });
	found = sequelize.query("SELECT * FROM listing WHERE isbn13 = '" + isbn13_ + "' AND available = true;", ListTable);
	found.then(function(record) {
		if(record != null)
		{
