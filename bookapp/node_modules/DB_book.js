...
var search = require("searchHandler");
...
exports.getBookByISBN13 = function getBookbyISBN13(isbn13_, function_) 
{
	...
	found.then(function(record){
		...
		if(record != null)
		{
			userValues = {title : record.dataValues.title.trim(),
...
exports.searchBook = function searchBook(query_, function_)
{
	var bookresult = sequelize.query(
			"SELECT * FROM book WHERE isbn10 = \'" +query_+ "\' OR isbn13 = \'" +query_+ "\' OR title LIKE \'%" +query_+ "%\' OR author LIKE \'%" +query_+ "%\';", BookTable
			 );
	
	bookresult.then(function(record){
		search.searchHandler(record, function_);
	});
}
